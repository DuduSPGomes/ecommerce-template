    ...
    | {
        ...
        edges: Array<{
          ...
          node: {
            ...
            variants?:
              | Array<
                  | { __typename?: 'ProductVariant'; name: string }
                  | null
                  | undefined
                >
              | null
            ...
            pricing?:
              ...
              | undefined
            category?:
              | { __typename?: 'Category'; id: string; slug: string }
              | null
              | undefined
          }
        }>
...
export type OneProductQuery = {
  ...
  product?:
    | {
        ...
        variants?:
          | Array<
              { __typename?: 'ProductVariant'; name: string } | null | undefined
            >
          | null
          | undefined
        pricing?:
 ...
 * });
 */
export function useOneProductQuery(
  baseOptions?: Apollo.QueryHookOptions<
    OneProductQuery,
    OneProductQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<OneProductQuery, OneProductQueryVariables>(
    OneProductDocument,
    options
  )
}
export function useOneProductLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    OneProductQuery,
    OneProductQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<OneProductQuery, OneProductQueryVariables>(
    OneProductDocument,
    options
  )
}
export type OneProductQueryHookResult = ReturnType<typeof useOneProductQuery>
export type OneProductLazyQueryHookResult = ReturnType<
  typeof useOneProductLazyQuery
>
export type OneProductQueryResult = Apollo.QueryResult<
  OneProductQuery,
  OneProductQueryVariables
>
